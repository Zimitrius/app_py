...
@app.route('/posts/<string:key>/<int:id>')  # chekc if wiki link exist for keyphrase
def key_detal(key, id):
	page = keyphrase_tools.check_wiki_page_exst(key)
	return render_template('chek_wiki.html', key=key.upper(), page=page, id=id)
